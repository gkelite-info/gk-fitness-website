...
import { saveTrainerWorkoutPlanDayExercise, deleteTrainerWorkoutPlanDayExercise } from '@/lib/helpers/trainerWorkoutPlans/trainerWorkoutPlanDayExercises';
import { saveTrainerWorkoutPlanDay } from '@/lib/helpers/trainerWorkoutPlans/trainerWorkoutPlanDays';
...
export function useSwapTrainerWorkoutDays() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const { fetchTrainerWorkoutPlanDayById } = await import('@/lib/helpers/trainerWorkoutPlans/trainerWorkoutPlanDays');
      const { fetchTrainerWorkoutPlanDayExercises } = await import('@/lib/helpers/trainerWorkoutPlans/trainerWorkoutPlanDayExercises');
