...
import { saveWorkoutPlanDayExercise, deleteWorkoutPlanDayExercise } from '@/lib/helpers/customerWorkoutPlans/workoutPlanDayExercises';
import { saveWorkoutPlanDay } from '@/lib/helpers/customerWorkoutPlans/workoutPlansDays';
...
export function useSwapWorkoutDays() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const { fetchWorkoutPlanDayById } = await import('@/lib/helpers/customerWorkoutPlans/workoutPlansDays');
      const { fetchWorkoutPlanDayExercises } = await import('@/lib/helpers/customerWorkoutPlans/workoutPlanDayExercises');
