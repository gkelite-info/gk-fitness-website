import { Crown, Users, CurrencyInr } from "@phosphor-icons/react/dist/ssr";
...
export default function PlanDetailsHero({ planName, activeMembers = 0, revenue = 0, renewals = 0 }: PlanDetailsHeroProps) {
  return (
    <div
