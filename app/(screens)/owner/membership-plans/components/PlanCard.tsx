...
import { Crown, CheckCircle, CalendarBlank, Users, DotsThree, NotePencil } from "@phosphor-icons/react";
...
export default function PlanCard({
  ...
  return (
    <div
      className={`flex flex-col justify-between p-[24px] rounded-[24px] transition-all w-[85vw] max-w-[320px] sm:max-w-none sm:w-[314px] shrink-0 h-full min-h-[475px] box-border ${
        isHighlighted
    ...
    >
        ...
        <div className="flex flex-col pt-[19px] gap-[14px] border-t border-[#23282F]">
          ...
          {extraFeaturesCount > 0 && (
            <div className="flex justify-end mt-[-8px]">
              <span 
                className={`px-[8px] py-[2px] rounded-[6px] text-[10px] font-[600] font-['Plus_Jakarta_Sans',sans-serif] leading-[16px] ${
                  isHighlighted 
      ...
      <div className="flex flex-col pt-[20px] gap-[20px] border-t border-[#23282F] mt-[24px]">
        ...
        <div className="flex flex-row items-center gap-[8px]">
          <button
            className={`flex-1 h-[46px] rounded-[16px] flex flex-row items-center justify-center gap-[8px] font-['Plus_Jakarta_Sans',sans-serif] font-[700] text-[14px] leading-[20px] transition-all cursor-pointer box-border ${
              isHighlighted
          ...
          <button className="w-[42px] h-[42px] rounded-[16px] bg-[#20252B] border border-[#2B333C] flex items-center justify-center text-[#9CA3AF] hover:text-white hover:bg-[#2a2c36] transition-all cursor-pointer shrink-0">
