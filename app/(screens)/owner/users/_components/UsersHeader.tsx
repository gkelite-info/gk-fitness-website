...
export default function UsersHeader() {
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center w-full mt-2 gap-4 sm:gap-0">
      ...
      <Link
        ...
        className="flex flex-row items-center justify-center px-5 py-2.5 gap-2 bg-[#D4FF32] hover:bg-[#c2ef2b] rounded-xl transition-all cursor-pointer shadow-[0_4px_6px_-4px_rgba(212,255,50,0.1)] active:scale-[0.98] w-full sm:w-auto"
      >
