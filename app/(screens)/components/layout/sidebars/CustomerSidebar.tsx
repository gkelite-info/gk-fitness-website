...
import { House, Heartbeat, Calendar, ClipboardText, Barbell } from "@phosphor-icons/react";

const navLinks = [
  { name: "Dashboard", href: "/customer", icon: House },
  { name: "My Plan", href: "/customer/plan", icon: ClipboardText },
  { name: "Diet", href: "/customer/diet", icon: Heartbeat },
  { name: "Attendance", href: "/customer/attendance", icon: Calendar },
];
